			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<ol class="breadcrumb">
					  ...
					  <li class="active"><i class="fas fa-folder-open" aria-hidden="true"></i> <?php echo $e3 ?></li>
					</ol>
				</div>
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="well">
						<div class="main-header">
							 <span><?php echo $e3 ?> <small><?php echo $d3 ?></small></span>
						</div>
					...
					<div class="box-sv box-green" style="margin-top:30px">
							<div class="box-sv-body">
								...
								<li class="list-text">แก้ไขที่ view/view3.php</li>
								<li class="list-text">แก้ไขที่ view/view3.php</strong></li>
								<li class="list-text">แก้ไขที่ view/view3.php</li>
								</ul>
							</div>
						</div>
